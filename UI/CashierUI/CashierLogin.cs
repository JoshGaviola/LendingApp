...
{
    public class CashierLogin : Form
    {
        ...
        private void BuildUI()
        {
            ...
            btnLogin.Click += SignInBtn_Click;
            ...
            txtPassword.KeyPress += (s, e) =>
            {
                ...
                {
                    SignInBtn_Click(btnLogin, EventArgs.Empty);
                }
            };
        }
        ...
        public void SignInBtn_Click(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                user = DataGetter.CurrentUser;

                CashierDashboard cashierDashboard = new CashierDashboard(data, user);
